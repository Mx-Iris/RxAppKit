...
class RxNSOutlineViewDataSource<OutlineNode: OutlineNodeType & Hashable & Differentiable>: OutlineViewDataSource<OutlineNode>, RxNSOutlineViewDataSourceType where OutlineNode.NodeType == OutlineNode {
    ...
    func outlineView(_ outlineView: NSOutlineView, observedEvent: Event<Element>) {
        Binder<Element>(self) { (dataSource: RxNSOutlineViewDataSource<OutlineNode>, newNodes) in
