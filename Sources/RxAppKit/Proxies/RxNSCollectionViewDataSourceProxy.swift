...
open class RxNSCollectionViewDataSourceProxy: DelegateProxy<NSCollectionView, NSCollectionViewDataSource>, DelegateProxyType, NSCollectionViewDataSource {
	...
	public static func registerKnownImplementations() {
		self.register { RxNSCollectionViewDataSourceProxy(collectionView: $0) }
	}
